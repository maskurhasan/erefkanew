...
function pangkat($id_Pangkat) {
  $q = mysql_query("SELECT nm_Pangkat FROM pangkat WHERE id_Pangkat = '$id_Pangkat'");
  $r = mysql_fetch_array($q);
  return $r[nm_Pangkat];
}

$arrkec = array('7322010' => 'Sabbang','7322020' => 'Baebunta','7322030'=>'Malangke');
