...
include "config/koneksi.php";
    ...
    if ($_GET['module']=='home'){
			...
			// modul dinonaktivkan karena langsung pada db sj
			...
			//untuk setting sementara ditiadakan
		...
		}elseif ($_GET['module']=='adminreport') {
			include "modul/modadminreport.php";
		}elseif ($_GET['module']=='pptk') {
			include "modul/modpptk.php";
		}else {
