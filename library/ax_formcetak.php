...
switch ($postur) {
 ...
 echo "<form method=get class='form-horizontal' action='report/rfkmodel2.php' target='_blank'>
              ...
              echo '<div class="form-group">
                ...
                <div class="col-sm-4">';
                  echo "<select class=form-control name=bulan required>
                ...
                <div class="col-sm-4">';
                  echo "<select class=form-control name=id_Ppk>
                    <option value='0'>Semua PPK</option>";
              ...
              <div class="clearfix form-actions">
                  <button class="btn btn-primary btn-fill" type="submit" name="cetak" value="Cetak"><i class="fa fa-print"></i> Cetak</button>
                  <button type="submit" class="btn btn-success btn-fill" name="excel" value="excel"><i class="fa fa-file-text"></i> Excel</button>
                  <button class="btn btn-primary btn-fill" type="button" name="view" id="id_Cetak" value="view"  onClick="ax_form_view(this.value)"><i class="fa fa-display"></i> View</button>
                  <button class="btn btn-success btn-fill" type="reset" value="Reset"><i class="fa fa-refresh"></i> Reset</button>
                </div>
            </form>';
    break;
	case 'rfkmodel2':
      echo "<form method=get class='form-horizontal' action='report/rfkmodel2.php' target='_blank'>
          ...
          echo "<div class=form-group>
                <label class='col-sm-2 control-label'>Tgl Laporan</label>
                <div class='col-sm-4'>
                  <input type='text'  class='form-control date-picker' data-date-format='yyyy-mm-dd' name='tgl'>
                </div>
              </div>";
...
<div class=form-group>
    ...
    case 'peta':
        ...
        echo "<form class='form-horizontal' method=get action='report/petakegiatanskpd.php' target='_blank'>";
                        echo '<div class="form-group">
                            <label for="inputPassword3" class="col-sm-2 control-label">Kegiatan</label>
                            <div class="col-sm-4">';
                            echo '<select class="form-control" name="id_DataKegiatan" id="id_DataKegiatan" onchange="pilih_Subkeg(this.value);">
            ...
            echo '<div class="clearfix form-actions">
                  <button class="btn btn-primary btn-fill" type="submit" name="cetak" value="Cetak"><i class="fa fa-view"></i> Tampilkan</button>
                  <button class="btn btn-success btn-fill" type="reset" value="Reset"><i class="fa fa-refresh"></i> Reset</button>
                </div>
              </form>';
      break;
      case 'petakeg':
        //echo '<iframe src="https://www.google.com/maps/d/embed?mid=zxNMsvBDrM3w.kIxx4ejWeDRU" width="640" height="480"></iframe>';
        echo "<form class='form-horizontal' method=get action='report/petaperkegiatan.php' target='_blank'>";
                        echo '<div class="form-group">
                            <label for="inputPassword3" class="col-sm-2 control-label">Kegiatan</label>
                            <div class="col-sm-4">';
                            echo '<select class="form-control" name="id_DataKegiatan" id="id_DataKegiatan" onchange="pilih_Subkeg(this.value);">
