  ...
  switch ($_GET[act]) {
    default:
          ...
          echo '<div class="col-md-4">
              ...
              <div class="content">';
         echo "<!--<p><button class='btn btn-md btn-info btn-fill btn-block' type=button id=id_Cetak value='rfkmodel1' onClick='ax_form_cetak(this.value)'><i class='pe-7s-note2'></i> Realisasi Fisik & Keuangan</button>--></p>
                  ...
                  <p><button class='btn btn-md btn-danger btn-fill btn-block' type=button id=id_Cetak value='rekapkec' onClick='ax_form_cetak(this.value)'><i class='fa fa-page'></i> Rekap Kecamatan</button></p>
                  ...
                  <p><a href='report/petaperkegiatan.php' target='_blank' class='btn btn-md btn-success btn-fill btn-block' type=button id=id_Cetak value='petakeg' onClick=''><i class='fa fa-page'></i> Peta Per Kegiatan</a></p>
