...
<?php
$qskpd = mysql_query("SELECT nm_Skpd FROM skpd WHERE id_Skpd = '$_GET[id_Skpd]'");
$rskpd = mysql_fetch_array($qskpd);
               ...
               while($r=mysql_fetch_array($q)) {
                  ...
                  echo "<td>$r2[nm_Lengkap]</td>
                        ...
                        <td>".frm_desimal($tr_fisik)."</td>
                        <td>".number_format($tr_keu)."</td>";//.number_format(trw($fl_bln,$r3[id_SubKegiatan],$arrtriwulan))."</td>";
                        echo "<td>".$rl_fisik."</td>
