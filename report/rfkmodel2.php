...
if($_GET['excel']=="excel") {
	...
	header("Content-Disposition: attachment; filename=rfk_skpd.xls");//ganti nama sesuai keperluan
...
<?php
$qskpd = mysql_query("SELECT * FROM skpd WHERE id_Skpd = '$_SESSION[id_Skpd]'");
$rskpd = mysql_fetch_array($qskpd);
                ...
                //fungsi
                /*
                function hittarget($id_DataKegiatan) {
                  $q3 = mysql_query("SELECT *
                                        FROM subkegiatan a
                                        LEFT JOIN target b
                                        ON a.id_SubKegiatan = b.id_SubKegiatan
               ...
               while($r=mysql_fetch_array($q)) {
                  ...
                  echo "<tr>
                    ...
                    while ($r2=mysql_fetch_array($q2)) {
                      ...
                      $q3 = mysql_query("SELECT *, SUM(b.tk1 + b.tk2) AS tr
                                        FROM subkegiatan a
                                        LEFT JOIN target b
                                        ON a.id_SubKegiatan = b.id_SubKegiatan
                                        WHERE a.id_DataKegiatan = '$r2[id_DataKegiatan]'");

                      $q3xx = mysql_query("SELECT *
                                        FROM subkegiatan a
                                        LEFT JOIN target b
                                        ON a.id_SubKegiatan = b.id_SubKegiatan
                                        WHERE a.id_DataKegiatan = '$r2[id_DataKegiatan]'");
					  ...
					  while ($r3=mysql_fetch_array($q3)) {
                        ...
                        if($_GET[bulan]==0) {
                          ...
                          $perkeu = ($r4['fs_besar'] / $r3[nl_Pagu]) * 100;
                          $rl_fisik = $r4['nl_besar'];
                          $rl_keu = $r4['fs_besar'];
                          ...
                          $r4 = mysql_fetch_assoc($sql4);
                          $perkeu = ($r4[t.$bln] / $r3[nl_Pagu]) * 100;
                          $rl_fisik = $r4[b.$bln];
                          $rl_keu = $r4[t.$bln];
                          //target bulanan
                          $tr_fisik = $r3[tf.$bln];
                  ...
                  echo "<td>$r2[nm_Lengkap]</td>
                        <td>".frm_desimal($tr_fisik)."</td>
                        <td>".frm_desimal($tr_fisik)."</td>
                        <td>".number_format($tr_keu)."</td>";//$tr_keu //.number_format(trw($fl_bln,$r3[id_SubKegiatan],$arrtriwulan))."</td>";
                        echo "<td>".$rl_fisik."</td>
          ...
          $tbln = "t".$_GET[bulan];
          $qt1=mysql_query("SELECT SUM(c.$tbln) AS totalrealisasi
          ...
          //hitung target
          $bln = $_GET[bulan];
          $qt2=mysql_query("SELECT SUM(c.tk$bln) AS totaltargetrp
                            FROM datakegiatan a,subkegiatan b,target c
                            WHERE a.TahunAnggaran = '$_SESSION[thn_Login]'
                            AND a.id_Skpd = '$_SESSION[id_Skpd]'
                            AND a.id_DataKegiatan = b.id_DataKegiatan
                            AND b.id_SubKegiatan = c.id_SubKegiatan");
          $rt2 = mysql_fetch_array($qt2);
          //total
          $tr_perkeu = ($rt2[totaltargetrp] / $rt[total]) * 100;

          //total
          $rl_perkeu = ($rt1[totalrealisasi] / $rt[total]) * 100;
          ...
          echo "<tr>
                  <td></td>
                      ...
                      <td></td>
                      <td></td>
                      <td>".format_angka($tr_perkeu)."</td>
                      <td>".format_angka($tr_perkeu)."</td>
                      <td>".number_format($rt2['totaltargetrp'])."</td>
                      <td>".format_angka($rl_perkeu)."</td>
                      <td>".format_angka($rl_perkeu)."</td>
                ...
                //pecah string nama Kantor
                $nmkantor = explode(" ",$rskpd[nm_Skpd]);
                echo '<table width="100%" id="tablemodul2" class="basic">
                  <tr>
                    <td valign="top"></td>
                    <td valign="top">&nbsp;</td>
                    <td valign="top">&nbsp;</td>
                  ...
                  <tr>
                    <td valign="top">&nbsp;</td>
                    <td valign="top">&nbsp;</td>
                    <td colspan="" valign="top"></td>
                    <td valign="top"><div align="center">Masamba, '.$_GET[tgl].'</div></td>
                  </tr>
                  <tr>
                    <td valign="top">&nbsp;</td>
                    <td valign="top">&nbsp;</td>
                  ...
                  <tr>
                    ...
                    <td valign="top">&nbsp;</td>
                    <td colspan="" valign="top"></td>
                    <td valign="top"><div align="center">Kepala '.$nmkantor[0].',</div></td>
                  </tr>
                  <tr>
                    <td valign="top">&nbsp;</td>
                    <td valign="top">&nbsp;</td>
                  ...
                  <tr>
                    ...
                    <td valign="top">&nbsp;</td>
                    <td colspan="" valign="top"></td>
                    <td valign="top"><div align="center"><strong><u>'.$rskpd[nm_Kepala].'</u></strong></div></td>
                  </tr>
                  <tr>
                    <td valign="top">&nbsp;</td>
                    <td valign="top">&nbsp;</td>
                    <td colspan="" valign="top"></td>
                    <td valign="top"><div align="center">Pangkat : '.pangkat($rskpd[id_Pangkat]).'</div></td>
                  </tr>
                  <tr>
                    <td valign="top">&nbsp;</td>
                    <td valign="top">&nbsp;</td>
                    <td colspan="" valign="top"></td>
                    <td valign="top"><div align="center">NIP : '.$rskpd[nip_Kepala].'</div></td>
                  </tr>
                </table>';
